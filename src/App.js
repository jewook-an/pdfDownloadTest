...
.page-common{
  ...
  width: 1920px;
  max-width: 100%;
  min-height: 2717px; /* height를 min-height로 변경 */
  height: auto; /* 높이 자동 조정 추가 */
  background-color: #fff;
  page-break-after: always;  /* 추가 */
  margin: 0;  /* 추가 */
  padding: 60px 40px; /* 여백 추가 */
...
/* 페이지 공통 */
/*.main {  position: relative; max-width: 1560px; padding: 6.5625vw 0; height: auto; }*/
.main {
  position: relative;
  width: 100%;
  height: auto;
...
function App() {
   ...
   // 데이터
   // const [setResultPageData] = useState();
   ...
   const fetchData = async () => {
      try {
         const response = await axios.post('https://test.behwan.co.kr/api/test/data')
         console.log('API Response:', response.data.data) // 전체 응답 데이터 확인
         console.log('Specific fields:', {
            unrest: response.data.data.unrest,
            melancholy: response.data.data.melancholy,
            anger: response.data.data.anger
         }) // 특정 필드만 확인
         setResultPageData(response.data.data)
      } catch (error) {
   ...
   useEffect(() => {
      ...
      fetchData();
      setResultPageData(resultPageData);
   ...
   if (!ref29ScoreType || !images || !resultPageData || !ref29ScoreResult) return;
   if (!ref29ScoreResult)
      console.log('ref29ScoreResult:', ref29ScoreResult);

  return (
    <div className="App">
      <button onClick={handleDownloadPdf}>PDf 다운로드 Total</button>
      <Container>
        ...
        <div className='page-common' ref={printPageRefs[2]}>
                        ...
                        <div className="col-group gap40 relative">
                           <div className="icon-arrow-wrap">
                              <div className="icon-arrow-both">
                                 <img src={images.icon_arrow_bold_down} className="icon-arrow-left" alt="" />
                                 <img src={images.icon_arrow_bold_down} className="icon-arrow-right" alt="" />
                              </div>
                              <div className="icon-arrow-both">
                                 <img src={images.icon_arrow_bold_down} className="icon-arrow-left" alt="" />
                                 <img src={images.icon_arrow_bold_down} className="icon-arrow-right" alt="" />
                        ...
                        {ref12TopThree.map((item, index) => (
                           <div className="green-border-box row-group gap32" key={index}>
                              <p className="default-title green col-group gap24 al-ce">
                                 <img data-test={item.img} src={images[item.img + '_green']} alt="" className="icon" />
                                 {item.name}
                              </p>
                              <p className="default-txt">
                        ...
                        {ref12BottomTwo.map((item, index) => (
                           <div className="red-border-box row-group gap32" key={index}>
                              <p className="default-title red col-group gap24 al-ce">
                                 <img src={images[item.img + '_red']} alt="" className="icon" />
                                 {item.name}
                              </p>
                              <p className="default-txt">
                                 {ref13Data[item.dataName].desc}
                        ...
                        <div className="step-item-list per-type border">
                           ...
                           <div className="col-group border-dash">
                              ...
                              <div className="step-item col-group gap24">
                                 ...
                                 <div className="step-item-txt-wrap row-group gap16">
                                    <p className="default-title">
                                       <span className="green">포용적 I</span>nClusive
                                    </p>
                                    <p className="default-txt default-txt-s">
               ...
               <div className="section-wrap row-group">
                  <div className="section">
                     ...
                     <div className="row-group gap32">
                        ...
                        <p className="default-txt">{PersonalityTypeText[PersonalityType()]}</p>
                     </div>
                  </div>
                  <div className="section">
                     <div className="section-title-wrap col-group">
         ...
         <div className='page-common' ref={printPageRefs[19]}>
            <main className="main">
         ...
         <div className='page-common' ref={printPageRefs[20]}>
            <main className="main">
                     ...
                     <div className="col-group gap40">
                        <div className="half-div row-group gap32">
                           ...
                           <div className="step-item-list border">
                              ...
                              <div className="step-item border-dash col-group gap24 active">
                                 <div className="step-item-num">04</div>
                                 <div className="step-item-txt-wrap row-group gap16">
                                    <p className="default-title green">
                                       DPMS 양육형
                  ...
                  {resultPageData.power_num === 1
                     ? (<div className="section">
                        <div className="section-title-wrap col-group">
                           <div className="num">3</div>
                           <h3 className="section-title">
                              {resultPageData.name}님은 [완벽을 추구하는 올곧은 사람], 장(본능) 중심입니다.
                           </h3>
                        </div>
                        <div className="row-group gap32">
                           <p className="default-txt">
                     ...
                     : resultPageData.power_num === 2
                        ? (<div className="section">
                           <div className="section-title-wrap col-group">
                              <div className="num">3</div>
                              <h3 className="section-title">
                                 {resultPageData.name}님은 [친절한 조력가], 가슴(감정) 중심입니다.
                              </h3>
                           </div>
                           <div className="row-group gap32">
                              <p className="default-txt">
                                 정이 많고 어려움에 처한 사람들에게 도움의 손길을 내밀며 주변 사람들에게 도움이 되는 일을 마다하지 않습니다. 타인이 필요로 하는 것에 몰두하지만 타인의 도움을 필요로 하고 있는 자신에 대해서는 자각하지 못합니다. 상대의 욕구를 충족시켜 주는 것 자체가 본래의 목적은 아니며 타인으로부터 애정과 호감을 받길 원합니다. <br />
                                 <br />
                                 이러한 행동의 바탕에는 타인이 자신을 인정해 주기를 바라는 마음과 보답을 받고 싶은 욕구가 있습니다. 예리한 직감을 갖고 있고 주위 사람들의 기분을 이해하기 때문에 적응력이 뛰어납니다. 또한, 다양한 자기 모습을 갖고 있어 상대방에 따라 다른 모습을 연출할 수 있습니다.
                              </p>
                              <div className="step-item-list border">
                                 <div className="step-item border-dash col-group gap24">
                                    <div className="step-item-num">01</div>
                        ...
                        : resultPageData.power_num === 3
                           ? (<div className="section">
                              <div className="section-title-wrap col-group">
                                 <div className="num">3</div>
                                 <h3 className="section-title">
                                    {resultPageData.name}님은 [성공을 향해가는 열정적 야심가], 가슴(감정) 중심입니다.
                                 </h3>
                              </div>
                              <div className="row-group gap32">
                                 <p className="default-txt">
                           ...
                           : resultPageData.power_num === 4
                              ? (<div className="section">
                                 <div className="section-title-wrap col-group">
                                    <div className="num">3</div>
                                    <h3 className="section-title">
                                       {resultPageData.name}님은 [특별함을 지향하는 예술가], 가슴(감정) 중심입니다.
                                    </h3>
                                 </div>
                                 <div className="row-group gap32">
                                    <p className="default-txt">
                              ...
                              : resultPageData.power_num === 5
                                 ? (<div className="section">
                                    <div className="section-title-wrap col-group">
                                       <div className="num">3</div>
                                       <h3 className="section-title">
                                          {resultPageData.name}님은 [관찰력이 뛰어난 연구가], 머리(사고) 중심입니다.
                                       </h3>
                                    </div>
                                    <div className="row-group gap32">
                                       <p className="default-txt">
                                 ...
                                 : resultPageData.power_num === 6
                                    ? (<div className="section">
                                       <div className="section-title-wrap col-group">
                                          <div className="num">3</div>
                                          <h3 className="section-title">
                                             {resultPageData.name}님은 [충직한 보안관], 머리(사고) 중심입니다.
                                          </h3>
                                       </div>
                                       <div className="row-group gap32">
                                          <p className="default-txt">
                                    ...
                                    : resultPageData.power_num === 7
                                       ? (<div className="section">
                                          <div className="section-title-wrap col-group">
                                             <div className="num">3</div>
                                             <h3 className="section-title">
                                                {resultPageData.name}님은 [즐거운 모험가], 머리(사고) 중심입니다.
                                             </h3>
                                          </div>
                                          <div className="row-group gap32">
                                             <p className="default-txt">
                                       ...
                                       : resultPageData.power_num === 8
                                          ? (<div className="section">
                                             <div className="section-title-wrap col-group">
                                                <div className="num">3</div>
                                                <h3 className="section-title">
                                                   {resultPageData.name}님은 [자신감 넘치는 도전가], 장(본능) 중심입니다.
                                                </h3>
                                             </div>
                                             <div className="row-group gap32">
                                                <p className="default-txt">
                                          ...
                                          : (<div className="section">
                                             <div className="section-title-wrap col-group">
                                                <div className="num">3</div>
                                                <h3 className="section-title">
                                                   {resultPageData.name}님은 [조화를 이루는 평화주의자], 장(본능) 중심입니다.
                                                </h3>
                                             </div>
                                             <div className="row-group gap32">
                                                <p className="default-txt">
               ...
               <div className="section-wrap row-group">
                  ...
                  <div className="section">
                     ...
                     <div className="green-border-box bg-green row-group gap4 prescription">
                        <p className="default-txt default-txt-l default-txt-bold dot">
                           지나치게 충성하거나 헌신적이 되지 않도록 신경써야 합니다.
                        </p>
                        <p className="default-txt default-txt-l default-txt-bold dot">
                        ...
                        <p className="default-txt default-txt-l default-txt-bold dot">
                           조언이나 피드백을 할 때는 사적인 생각보다는 타인의 성장에 집중하여
                           객관적이고 유용한 내용을 전할 필요가 있습니다.
                        </p>
                        <p className="default-txt default-txt-l default-txt-bold dot">
                           발표를 할 때는 객관적인 정보를 제공하고 세부사항의 경우 초점을 유지해야
                           한다는 사실을 기억하세요.
                        </p>
                     </div>
                  </div>
         ...
         <div className='page-common' ref={printPageRefs[29]}>
            <main className="main">
               ...
               <div className="section-wrap row-group">
                  ...
                  <div className="section life-score-section age5">
                     ...
                     <div className="life-score-result-wrap col-group gap56">
                        <div className="row-group gap56">
                           ...
                           <div className="row-group gap32">
                              ...
                              <p className="default-txt default-txt-l default-txt-bold green">리뷰가 없습니다</p>
                           </div>
                        </div>
                        <div className="chart">
               ...
               <div className="section-wrap row-group">
                  <div className="section">
                     ...
                     <div className="row-group gap24">
                        ...
                        <p className="default-txt">remember 없습니다</p>
                     </div>
                  </div>
                  <div className="section">
                     <div className="section-title-wrap col-group">
                     ...
                     <div className="row-group gap24">
                        ...
                        <p className="default-txt">reinterpretation 없습니다</p>
                     </div>
                  </div>
                  <div className="section">
                     <div className="section-title-wrap col-group">
                     ...
                     <div className="row-group gap24">
                        ...
                        <p className="default-txt">refresh 없습니다</p>
                     </div>
                  </div>
               </div>
            </main>
               ...
               <div className="section-wrap row-group">
                  <div className="section">
                     ...
                     <div className="result-score-container col-group gap40">
                        ...
                        <div className="result-score-txt-wrap row-group gap40">
                           <div className="result-score-txt type3">
                              당신의 융합역량은 <span className="color">{selectedItem.title}</span>입니다.
                           </div>
                           <p className="default-txt">
                              IQ와 EQ를 넘어서는 μετά Q 융합역량지수는 우리가 ‘의미’와 ‘가치’의 문제를 다루고 해결할 때 사용하는 역량이며, 우리의 행동과 삶을 광범위하고 풍부한 의미의 맥락에 자리매김할 수 있게 하는 역량입니다. <br />
                              <br />
                              자아나 의식적인 생각을 초월하는, 자기의 깊은 부분에 존재하는 지혜와 연관된 역량이며 기존의 가치를 인식하는 데 그치지 않고 새로운 가치를 창조적으로 발견하게 하는 역량입니다. <br />
                              <br />
                              개인의 정서지수와 다중역량지수, 그리고 에너지 방향과 의사소통 방식 등에 따른 기능지수를 통합적으로 분석한 결과입니다.
                           </p>
                        </div>
                     </div>
                  </div>
